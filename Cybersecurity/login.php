      ...
      <div class="row contact-wrap">
        <div class="col-md-6 col-md-offset-3">
          ...
          <?php
				...
				?>
         <form action="login-process.php" method="post" role="form" class="contactForm">
			...
			<label>Password</label>
			 ...
			 <div class="text-center"><input type="submit" name="signin" value="SignIn" class="btn btn-danger btn-lg "></div>
            <div class="forminput">
