          ...
          <div class="menu">
            <ul class="nav nav-tabs" role="tablist">
             ...
             <li role="presentation"><a href="file.php">File Upload</a></li>
              ...
              <li role="presentation"><a href="booking.php"  class="active"> Manage Booking</a></li>
            </ul>
          </div>
        </div>
      </div>
					...
					?>
                        ...
                        <td>
	                          ...
	                          <?php
								...
								$url1= "booking-process.php?id=".$user['id']."&act=delete";
								$url2="event.php?id=".$user['id']."&act=edit";
								
								?>
								<a href="<?php echo $url2; ?>" style="border-radius:50%" class="btn btn-success">EDIT</a>
								<a href="<?php echo $url1?>" style="border-radius:50%" class="btn btn-danger" >DELETE</a>
							</td>
